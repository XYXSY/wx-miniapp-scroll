...
export function timestampToTime(timestamp, needhms = true) {
...
export function btnDisabled(menuId, name) {
  let data = this.$store.state.permission.btnPermission;
  let str = "";
  for (var i of data) {
    if (menuId === i.parentId) {
      str += i.perms + ",";
    }
  }
...
export function getCompNameByPath(path) {
